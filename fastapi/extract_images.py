...
parser.add_argument('--start_time', type=float,default='0', help='Start time (in seconds) to extract images from')
parser.add_argument('--end_time', type=float,default='99999999999999999', help='End time (in seconds) to extract images to')
